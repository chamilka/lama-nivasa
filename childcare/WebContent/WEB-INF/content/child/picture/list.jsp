	 ...
	 <s:if test="list.size > 0">
		<table style="margin-top: 10px" width="100%" id="commonTable"
			...
			<s:iterator value="list" status="rowIndex">
				<tr>
					<td><s:url var="imageShowUrl" action="image-view"
							namespace="/childPicture" includeParams="none">
							<s:param name="id" value="id"></s:param>
						</s:url> <s:url var="imageLargeViewUrl" action="image-view-page"
							namespace="/childPicture" includeParams="none">
							<s:param name="id" value="id"></s:param>
						</s:url> <sj:a href="%{#imageLargeViewUrl}" targets="imageDiv">
					...
					<s:if test="probationOfficer">
						<td><s:url var="childPictureDeleteUrl" action="delete"
							...
							</s:url> <sj:a href="%{childPictureDeleteUrl}"
								targets="childPictureResultDiv" onClickTopics="/confirmDelete">
								<s:text name="page.view.button.delete" />
							</sj:a></td>
					</s:if>
				</tr>
			</s:iterator>
