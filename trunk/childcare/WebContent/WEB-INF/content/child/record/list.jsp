...
<%@ taglib prefix="sj" uri="/struts-jquery-tags" %>
	...
	<div>
	  ...
	  <table style="margin-top: 10px" width="100%" id="commonTable" class="blueTbl">
	  	<tr>
	  		<th></th><th><s:text name="page.record.edit"/></th><th><s:text name="page.record.date"/></th><th><s:text name="page.record.comment"/></th>
	  	</tr>
			<s:iterator value="list" status="rowIndex">
				<tr>
				 ...
				 <td style="width:80px">
				 	...
				 	<sj:a href="%{#childRecordViewUrl}" targets="childRecordResultDiv"><s:text name="page.record.view"/></sj:a>
				 	|
				 	<s:url var="childRecordEditUrl" action="edit" namespace="/childRecord" includeParams="none" >
		  					<s:param name="id" value="%{id}"></s:param>
		  			</s:url>
				 	<sj:a href="%{#childRecordEditUrl}" targets="childRecordResultDiv"><s:text name="page.record.edit"/></sj:a>
				 </td>
