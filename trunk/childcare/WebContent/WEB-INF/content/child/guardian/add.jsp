...
<%@ taglib prefix="sj" uri="/struts-jquery-tags" %>
	...
	<div>
	  <table>
	   <tr>
	   		<td class="td3" style="width:5px">&nbsp;</td><td class="sub-title">Guardian Information</td>
	   </tr>
	  </table>
	</div>
	<div>
	...
	<s:hidden name="operationMode"/>
	  ...
	  <sj:submit value="SUBMIT" targets="childGuardianResultDiv" cssStyle="margin-left:150px"/>
	</s:form>
